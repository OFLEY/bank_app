...
def bank_menu(username, balance, users):
    ...
    while True:
        ...
        if choice == "1":
            ...
            print(f'\nКоличество пополнений: {transaction_history[0]}\nКоличество снятий: {transaction_history[1]}\nКоличество переводов: {transaction_history[2]}')
        else:
